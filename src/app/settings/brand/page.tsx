...
export default function BrandSettingsPage() {
  ...
  // Form state
  const [appName, setAppName] = useState<string>("Creatik Ai Staff Management");
  const [shortName, setShortName] = useState<string>("Creatik Ai");
  ...
  const loadSettings = async () => {
    ...
    if (res?.success && res?.data) {
      ...
      setAppName(data.appName || "Creatik Ai Staff Management");
      setShortName(data.shortName || "Creatik Ai");
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div>
            ...
            <input
              ...
              placeholder="e.g. Creatik Ai Staff Management"
